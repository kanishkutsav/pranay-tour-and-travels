...
const packages = [
  { title: 'Ram Janmabhoomi & Ayodhya', location: 'Ayodhya · 3 days', destinations: ['Ayodhya'], price: '₹9,999', tag: 'Spiritual trail', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ram%20Janmbhoomi%20Mandir%2C%20Ayodhya%20Dham.jpg?width=1000' },
  { title: 'The Taj Mahal story', location: 'Agra · 2 days', destinations: ['Agra'], price: '₹7,499', tag: 'Heritage pick', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Taj%20Mahal%20in%20March%202004.jpg?width=1000' },
  { title: 'Varanasi by the Ganga', location: 'Varanasi · 4 days', destinations: ['Varanasi'], price: '₹12,499', tag: 'Soulful escape', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ganga%20Dwar%2C%20Gateway%20of%20Corridor%20of%20Kashi%20Vishwanath%20Temple%2C%20Varanasi%202.webp?width=1000' },
  { title: 'Prayagraj confluence', location: 'Allahabad · 3 days', destinations: ['Allahabad'], price: '₹8,999', tag: 'River retreat', image: '/prayagraj-confluence.png' },
  { title: 'Lucknow tehzeeb trail', location: 'Lucknow · 3 days', destinations: ['Lucknow'], price: '₹8,499', tag: 'Culture pick', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Bara%20Imambara%20Lucknow.jpg?width=1000' },
  { title: 'Bodh Gaya awakening', location: 'Bodh Gaya · 3 days', destinations: ['Bodh Gaya'], price: '₹10,999', tag: 'Buddhist trail', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Mahabodhi%20temple%20complex.jpg?width=1000' },
  { title: 'Vindhyachal blessings', location: 'Vindhyachal · 2 days', destinations: ['Vindhyachal'], price: '₹6,999', tag: 'Temple trail', image: '/vindhyachal-temple.png' },
  { title: 'Deoghar temple trail', location: 'Deoghar · 3 days', destinations: ['Deoghar'], price: '₹8,999', tag: 'Sacred journey', image: '/deoghar-temple.png' },
  { title: 'Nalanda knowledge trail', location: 'Nalanda · 2 days', destinations: ['Nalanda'], price: '₹7,999', tag: 'Ancient India', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Nalanda%20ruins.jpg?width=1000' },
  { title: 'Rajgir hills & peace', location: 'Rajgir · 3 days', destinations: ['Rajgir'], price: '₹9,499', tag: 'Slow travel', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Vishwa%20Shanti%20Stupa%2C%20Rajgir.jpg?width=1000' },
]
    ...
    <main>
      <section className="hero-section">
        <nav className="navbar" aria-label="Main navigation">
          <a className="brand" href="#top" aria-label="Pranay Tour and Travels home"><span className="brand-mark"><Compass size={22} strokeWidth={2.5} /></span><span>Pranay <em>Tour &amp; Travels</em></span></a>
      ...
      <section className="experience-section" id="experiences">
        ...
        <div className="package-grid">{packages.map((trip) => <article className="package-card" key={trip.title}><div className="package-image"><img src={trip.image} alt={trip.title} /><span>{trip.tag}</span><button type="button" aria-label={`Save ${trip.title}`}><Heart size={17} /></button></div><div className="package-body"><div className="package-location"><MapPin size={14} /> {trip.location}</div><h3>{trip.title}</h3><div className="package-footer"><p>from <strong>{trip.price}</strong> <small>/ person</small></p><a href="#top" aria-label={`View ${trip.title}`} onClick={(event) => { event.preventDefault(); openCallbackForm() }}><ArrowRight size={18} /></a></div></div></article>)}</div>
      </section>

      <section className="trust-section"><div className="trust-copy"><div className="section-kicker">Travel with ease</div><h2>The details are ours.<br /><i>The memories are yours.</i></h2><p>From your first hello to the last sunset, our on-ground experts are here to make every part of your trip feel effortless.</p><button className="dark-button" type="button" onClick={openCallbackForm}>Plan my journey <ArrowRight size={17} /></button><div className="contact-stat"><strong>Contact us</strong><span><a href="tel:9919655559">9919655559</a><br /><a href="mailto:ukindiavns@gmail.com">ukindiavns@gmail.com</a></span></div></div><div className="trust-list"><div><ShieldCheck size={24} /><span><strong>Real people, always</strong>Someone from our team is never more than a call away.</span></div><div><Compass size={24} /><span><strong>Made locally</strong>Stay with people who know their home by heart.</span></div><div><Star size={24} /><span><strong>4.9 from 8,000+ travellers</strong>Good trips are better when they come recommended.</span></div></div></section>
      <footer><a className="brand" href="#top"><span className="brand-mark"><Compass size={20} strokeWidth={2.5} /></span><span>Pranay <em>Tour &amp; Travels</em></span></a><span>Journeys with a little more soul.</span><span>© 2026 Pranay Tour and Travels</span></footer>
