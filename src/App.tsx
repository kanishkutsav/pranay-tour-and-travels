...
function App() {
  ...
  const handleCallbackSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!trip) {
      setFormError('Please enter the trip you are interested in.')
      return
    }
