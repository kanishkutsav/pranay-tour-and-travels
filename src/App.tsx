...
function App() {
  ...
  return (
    <main>
      ...
      <a className="mobile-whatsapp" href={whatsappLink} target="_blank" rel="noreferrer" aria-label="Chat with Pranay Tour and Travels on WhatsApp"><MessageCircle size={22} /></a>
